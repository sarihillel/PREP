...
(function (window, document, exports, global, define, undefined) {
    ...
    function renderDocument(document, options, windowWidth, windowHeight, html2canvasIndex) {
        return createWindowClone(document, document, windowWidth, windowHeight, options, document.defaultView.pageXOffset, document.defaultView.pageYOffset).then(function (container) {
            ...
            $(clonedWindow.document.body).children().find('#formal-button').hide();
            $(clonedWindow.document.body).children().find('#draft-button').hide();
            $(clonedWindow.document.body).children().find('#save-status').hide();
    ...
    function createWindowClone(ownerDocument, containerDocument, width, height, options, x, y) {
        ...
        resolve(container);
            ...
            documentClone.replaceChild(options.javascriptEnabled === true ? documentClone.importNode(documentElement, true) : removeScriptNodes(documentClone.importNode(documentElement, true)), documentClone.documentElement);
            documentClone.close();
        });
    }
