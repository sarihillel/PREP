    ...
    $.post(Url.publishCP, data)
        .done(function (data) {
            if (data.Result == "ExistQuestions") {
                confirm("Please note that some questions belong to the selected CP but are not effective yet. These questions will now become effective and their Risk Level will be set to High", information, ChangeRiskLevel);
            }
            else {
                exitPopUpWindow();
    ...
    html2canvas(document.body,
        {
            ...
            onrendered: function (canvas) {
               ...
               //     { name: 'base64string', value: imageData.split(',')[1] }
               ...
               // CustomConfirm("Preparing your Mail, Please wait....  ", loadingSave);
                var alertSave = CustomConfirm("Preparing your Mail, Please wait....  ", loadingSave);
                PopUpMailWindow(Url.preparePublicationMail, data, alertSave);
